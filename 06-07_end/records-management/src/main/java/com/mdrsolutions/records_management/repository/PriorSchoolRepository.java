...
public interface PriorSchoolRepository extends JpaRepository<PriorSchool, Long> {
    ...
    PriorSchool findByStudentStudentIdAndOrderIndex(Long studentId, Integer orderIndex);

    List<PriorSchool> findByStudentStudentIdOrderByOrderIndexAsc(Long studentId);
