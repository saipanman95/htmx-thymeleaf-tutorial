...
public class PriorSchoolController {
    ...
    public HtmxResponse savePriorSchoolReturnOne(@PathVariable Long studentId,
                                                 @ModelAttribute PriorSchool priorSchool,
                                                 Model model) {
        LOGGER.info("savePriorSchoolReturnOne(...) - studentId: {}", studentId);
        Student student = studentService.getStudentById(studentId);
        priorSchool.setStudent(student);
        
        //saving student prior school
        PriorSchool ps = priorSchoolService.savePriorSchool(priorSchool);
        
        //refreshing student entity;
        ...
        // Refresh the list of prior schools and mark for review
//        List<PriorSchool> priorSchools = priorSchoolService.getPriorSchoolsByStudentId(studentId);
        ...
        return HtmxResponse.builder()
                .view("priorSchool/prior-school-table-row :: prior-school")
                .view("student/mark-for-review :: mark-for-review-info").build();
    }

    @PutMapping("/school/{id}/update")
    @HxRequest
    public HtmxResponse updatePriorSchool(@PathVariable Long id,
                                    @ModelAttribute PriorSchool priorSchool,
                                    Model model) {
