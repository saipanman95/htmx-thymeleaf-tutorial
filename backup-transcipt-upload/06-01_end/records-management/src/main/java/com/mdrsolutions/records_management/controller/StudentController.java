...
public class StudentController {
    ...
    public StudentController(StudentService studentService, CheckStudentMissingFieldService missingFieldService, PriorSchoolService priorSchoolService, TranscriptService transcriptService) {
    ...
    public String viewStudentFullDetails(@PathVariable("studentId") Long studentId, Model model) {
        ...
        LOGGER.info("transcrips = {}",transcriptDtoList.size());
        ...
        model.addAttribute("transcripts", transcriptDtoList);
